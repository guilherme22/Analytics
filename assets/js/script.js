...
function charts(listatotal) {
    //  jQuery Flot Chart
//    var total = listatotal
    var total = [
        [1, 43],
        [2, 35],
        [3, 49],
 ...
 var dataSet2 = [{
    ...
    var placeholder = $("#pie2");
    $.plot(placeholder, dataSet2, {
        series: {
            pie: {
                show: true,
                combine: {
